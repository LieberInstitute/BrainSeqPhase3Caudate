...
GCTA="/ceph/opt/fusion_twas-master/gcta64"
COVAR="../../_m/junctions/Brainseq_LIBD.cov"
PLINK="/home/jbenja13/software/plink_1.9/plink"
GEMMA="/ceph/opt/fusion_twas-master/gemma-0.98.1"
PRE_GEXP="../../_m/junctions/twas_gene_expression.txt"
LDREF="../../../../inputs/twas/reference_hg38/_m/LDREF_hg38"
CHR_INFO="/ceph/genome/human/gencode26/GRCh38.p10.ALL/chromInfo/_m/chromInfo.txt"
PRE_GENO="../../../../inputs/genotypes/to_brnum/phase3_plink/byChrom/_m/Brainseq_LIBD"
...
cat $PRE_GEXP | \
    awk -vs=$BATCH_START -ve=$BATCH_END 'NR > s && NR <= e' |  \
    while read PARAM; do
