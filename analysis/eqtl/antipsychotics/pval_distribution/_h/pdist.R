...
fn1 = paste0("/ceph/projects/v4_phase3_paper/analysis/eqtl_analysis/",
            "diagnosis_interaction/genes/prepare_expression/",
            "fastqtl_nominal/_m/Brainseq_LIBD.allpairs.txt.gz")
label1 = "SNPxDiagnosis"
dist_comp(fn1, label1)
dist_comp_topVariant(fn1, label1)
## Using main analysis
fn2 = paste0("/ceph/projects/v4_phase3_paper/analysis/eqtl_analysis/all/",
             "genes/expression_gct/prepare_expression/fastqtl_nominal/_m/",
             "Brainseq_LIBD.allpairs.txt.gz")
label2 = "main"
dist_comp(fn2, label2)
dist_comp_topVariant(fn2, label2)
## Using control only analysis
fn3 = paste0("/ceph/projects/v4_phase3_paper/analysis/eqtl_analysis/",
             "control_only/genes/expression_gct/prepare_expression/",
             "fastqtl_nominal/_m/Brainseq_LIBD.allpairs.txt.gz")
label3 = "control"
dist_comp(fn3, label3)
dist_comp_topVariant(fn3, label3)
