...
## with SZ no AP dysregulation. Replication in GTEx.
library(tidyverse)
...
fn1 = paste0("/ceph/projects/v4_phase3_paper/analysis/eqtl_analysis/",
             "gtex_caudate/genes/expression_gct/prepare_expression/",
             "fastqtl_nominal/_m/GTEx_caudate.allpairs.txt.gz")
label1 = "GTEx_caudate"
dist_comp(fn1, label1)
dist_comp_topVariant(fn1, label1)
## Nucleus accumbens
fn2 = paste0("/ceph/projects/v4_phase3_paper/analysis/eqtl_analysis/",
             "gtex_accumbens/genes/prepare_expression/fastqtl_nominal/",
             "_m/GTEx_accumbens.allpairs.txt.gz")
label2 = "GTEx_accumbens"
