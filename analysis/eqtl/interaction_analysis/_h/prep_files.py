...
def extract_eqtls(feature):
    ...
    ### Caudate
    cc_file = "/ceph/projects/v4_phase3_paper/analysis/eqtl_analysis/"+\
        "all/%s/expression_gct/prepare_expression/" % feature +\
        "fastqtl_nominal/_m/Brainseq_LIBD.allpairs.txt.gz"
    caudate = load_eqtl(cc_file)
    ### DLPFC
    dlpfc_file = "/ceph/projects/v4_phase3_paper/analysis/eqtl_analysis/"+\
        "bsp2/dlpfc/%s/prepare_expression/fastqtl_nominal/" % feature +\
        "_m/Brainseq_LIBD.allpairs.txt.gz"
    dlpfc = load_eqtl(dlpfc_file)
    ### Hippocampus
    hippo_file = "/ceph/projects/v4_phase3_paper/analysis/eqtl_analysis/"+\
        "bsp2/hippocampus/%s/prepare_expression/fastqtl_nominal/" % feature +\
        "_m/Brainseq_LIBD.allpairs.txt.gz"
